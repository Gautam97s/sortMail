...
class Task(Base):
    ...
    status = Column(
        Enum(TaskStatus, name="taskstatus", native_enum=False, validate_strings=True),
        default=TaskStatus.PENDING,
        nullable=False,
    )
    task_type = Column(
        Enum(TaskType, name="tasktype", native_enum=False, validate_strings=True),
        default=TaskType.REPLY,
        nullable=False,
    )
