            ...
            {intel.suggested_action && (
                <section className="space-y-4">
                    ...
                    <div className="space-y-2">
                        {/* We map the suggested actions here. If backend has tasks, we map those. 
                            For now we use the suggested_action or suggested_reply_points */}
                    ...
                    <div className="space-y-3">
                        {intel.attachment_summaries.map((att) => (
                            <AttachmentIntelCard
                                ...
                                filename={att.attachment_id} // In real app, name is in thread attachments
                                intel={att}
