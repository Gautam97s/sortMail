            ...
            <div className="py-4 px-3 space-y-1 mt-auto border-t border-border bg-paper-mid/30">
                    ...
                    return (
                        <Link
                            ...
                            className={`
                                    ...
                                    ${isActive ? "bg-accent/10 text-accent font-semibold" : "text-muted hover:bg-paper-mid hover:text-ink"}
                                    ${collapsed ? "justify-center" : ""}
                                `}
                            title={collapsed ? item.label : undefined}
                        >
                ...
                {!collapsed && (
                    <div className="pt-4 pb-1 px-3">
                        <span className="text-[10px] font-mono font-bold text-muted/40 uppercase tracking-widest">Growth</span>
                    </div>
                )}
                {[
                    { label: "Referrals", href: "/referral", icon: Share2 },
                    { label: "AI Credits", href: "/credits", icon: Zap },
                ...
                {!collapsed && (
                    <div className="pt-4 pb-1 px-3">
                        <span className="text-[10px] font-mono font-bold text-muted/40 uppercase tracking-widest">System</span>
                    </div>
                )}
                {[
