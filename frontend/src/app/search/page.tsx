                    ...
                    <div className="flex flex-wrap items-center gap-1.5 md:gap-2 mt-3 md:mt-4">
                        ...
                        {FILTER_OPTIONS.map((filter) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`
                                        flex items-center gap-1 md:gap-1.5 px-2.5 md:px-3 py-1 md:py-1.5 rounded-md text-[10px] md:text-xs font-medium transition-colors
                                        ${isActive
                        ...
                        {(activeFilters.length > 0 || searchQuery) && (
                            <Button
                                ...
                                className="h-6 px-2 text-[10px] md:text-xs text-muted hover:text-ink"
                            >
                                Clear all
                            </Button>
                        )}
                                            ...
                                            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 sm:gap-4">
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center gap-2 mb-1">
                                                        <h3 className="font-medium text-ink text-sm md:text-base truncate">
                                                            {thread.subject}
                                                        </h3>
                                                    ...
                                                    <p className="text-xs md:text-sm text-muted line-clamp-2 mb-2">
                                                        {thread.summary}
                                                    </p>
                                                    <div className="flex items-center justify-between sm:justify-start gap-2">
                                                        <Badge
                                                            variant="secondary"
                                                            className={`text-[10px] md:text-xs px-1.5 md:px-2 py-0 md:py-0.5 ${getIntentColor(thread.intent)}`}
                                                        >
