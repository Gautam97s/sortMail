                ...
                <div className="flex-1 overflow-y-auto px-3 md:px-8 py-4 md:py-6 custom-scrollbar">
                    {isLoading ? (
                        <div className="max-w-4xl mx-auto space-y-4 pt-4">
                            {[...Array(4)].map((_, i) => (
                                <div key={i} className="h-28 bg-paper-mid animate-pulse rounded-xl border border-border-light" />
                            ))}
                        </div>
                    ) : (
                        <>
                            {!searchQuery && results.length === 0 && (
                                <div className="flex flex-col items-center justify-center h-full text-center py-12">
                                    ...
                                    <p className="text-muted max-w-md text-sm leading-relaxed">
                                        Find emails, tasks, and insights quickly. Select a thread to view deep RAG context.
                                    </p>
                                </div>
                            )}
